...
func (x *StatValue) GetFloatNumeratorVal() *wrappers.DoubleValue {
	if x != nil {
...
func (x *StatValue) GetFloatDenominatorVal() *wrappers.DoubleValue {
	if x != nil {
...
func (x *StatValue) GetIntNumeratorVal() *wrappers.Int64Value {
	if x != nil {
...
func (x *StatValue) GetIntDenominatorVal() *wrappers.Int64Value {
	if x != nil {
...
func (x *StatValue) GetStringVal() *wrappers.StringValue {
	if x != nil {
		return x.StringVal
	}
	return nil
...
func (x *StatValue) GetBoolVal() *wrappers.BoolValue {
	if x != nil {
		return x.BoolVal
	}
	return nil
...
var file_plugins_shared_structs_proto_stats_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x65, 0x73, 0x63, 0x42, 0x45,
	0x5a, 0x43, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x70, 0x65,
	0x6e, 0x77, 0x6f, 0x6e, 0x74, 0x6f, 0x6e, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x77, 0x6f, 0x6e, 0x74,
	0x6f, 0x6e, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65,
	0x64, 0x2f, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
