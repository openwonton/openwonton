...
description: Learn about the OpenWonton's interpolation and interpreted variables.
---

# Variable Interpolation

OpenWonton supports interpreting two classes of variables: node attributes and
...
OpenWonton supports interpreting two classes of variables: [node attributes](#interpreted_node_vars)
...
The syntax for interpreting variables in the OpenWonton job specification is
...
OpenWonton interprets dots in names as object notation. This causes names that have
...
`Extra characters after interpolation expression` error. OpenWonton provides a
