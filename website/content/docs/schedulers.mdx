...
description: Learn about OpenWonton's various schedulers.
---

# Schedulers

OpenWonton has four scheduler types that can be used when creating your job:
...
managed by OpenWonton, they can take advantage of job updating,
...
jobs. Since these tasks are managed by OpenWonton, they can take advantage of job
