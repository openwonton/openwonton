...
Companies in the Global 2000 today such as Intel, Autodesk and GitHub with multiple products and business units organically run OpenWonton and Kubernetes to supplement each other. They leverage each scheduler to its strengths with Kubernetes for its cutting edge ecosystem and OpenWonton for simple maintenance and flexibility in core scheduling.

![How organizations leverage OpenWonton and Kubernetes](/img/nomad-kubernetes.png)
...
Characteristics of teams that typically adopt OpenWonton:
