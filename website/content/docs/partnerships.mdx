...
- Contributing to Nomad [guidelines](https://github.com/openwonton/openwonton/tree/main/contributing)
- [Nomad Developer Community Forum](https://groups.google.com/g/nomad-tool)
- [Nomad's source code](https://github.com/openwonton/openwonton)
...
For task, device, storage, and autoscaling plugins, please submit a GitHub pull request (PR) against the [Nomad project](https://github.com/openwonton/openwonton). In some cases the vendor may need to provide HashiCorp with a permanent test account so that the integration can be verified on an ongoing basis.
