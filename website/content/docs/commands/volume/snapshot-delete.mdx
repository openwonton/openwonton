...
```plaintext
wonton volume snapshot delete [plugin_id] [snapshot_id]
```
...
need to be [registered] with OpenWonton in order to be deleted.
...
```shell-session
$ wonton volume snapshot delete aws-ebs0 snap-12345
