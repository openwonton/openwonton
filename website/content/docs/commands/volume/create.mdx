...
The `volume create` command creates external storage volumes with OpenWonton's
...
```plaintext
wonton volume create [options] [file]
```
...
file will be read and the volume will be submitted to OpenWonton for scheduling. If
