...
```plaintext
wonton operator gossip keyring remove [options] <key>
```
...
```shell-session
$ wonton operator gossip keyring remove HD5Y61iE+neTxd1n6TnXhCPViPIUq5QpWq8WW8012XA=
Removing gossip encryption key...
error: Unexpected response code: 500 (3/3 nodes reported failure)

$ wonton operator gossip keyring remove AOUfjGff+MrTBzNU7NCOTmYajKRkGv8r2ToxheWd+jk=
Removing gossip encryption key...
```
