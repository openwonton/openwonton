...
```plaintext
wonton operator gossip keyring list [options]
```
...
The output of the `wonton operator gossip keyring list` command
consolidates information from all the OpenWonton servers.
