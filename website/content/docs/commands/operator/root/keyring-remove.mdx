...
```plaintext
wonton operator root keyring remove [options] <key ID>
```
...
```shell-session
$ wonton operator root keyring remove 48596ce5-3ff5-8f77-2dcf-301682ada0ce
error: Unexpected response code: 500 (active root key cannot be deleted - call rotate first)

$ wonton operator root keyring remove 33374156-9f81-b14c-83d4-a2f1f87dbf99
