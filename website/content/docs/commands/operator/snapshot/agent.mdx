...
description: |
  Periodically saves snapshots of OpenWonton server state
---
...
This snapshot agent only saves a Raft snapshot. Key material for the OpenWonton
...
```plaintext
wonton operator snapshot agent [options] <config_file>
```
