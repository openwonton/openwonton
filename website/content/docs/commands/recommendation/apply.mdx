...
```plaintext
wonton recommendation apply [options] <recommendation_ids>
```
...
```shell-session
$ wonton recommendation apply a9c041c5-3c04-aa24-bd55-0a80cded4f10
...
```shell-session
$ wonton recommendation apply a9c041c5-3c04-aa24-bd55-0a80cded4f10 811900b6-da11-ef08-f515-f5e6684007a8
Errors
None
