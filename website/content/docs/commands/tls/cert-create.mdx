...
description: |
  This command creates a Certificate that can be used for OpenWonton TLS setup.
---

# Command: nomad tls cert create

The `tls cert create` command is used to create certificates to be used for
[TLS encryption][] for your OpenWonton cluster. You can then copy these to your
