...
description: |
  Login to OpenWonton using an authentication method
---

# Command: login

The `login` command is used to log in to an SSO provider and exchange the third
party credentials for a newly minted OpenWonton ACL token.

## Usage

```plaintext
wonton login [options]
```
