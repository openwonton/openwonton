...
description: |-
  The "var list" command lists data from OpenWonton's variables datastore at
...
```plaintext
wonton var list [options] [<prefix>]
```
...
```shell-session
$ wonton var list -out=json -namespace="*" nomad/jobs/variable/www
[
  {
    "Namespace": "default",
...
```shell-session
$ wonton var list -out=json -namespace="*" -per-page=1 nomad/jobs/variable/www
{
    "Data": [
        {
           "Namespace": "default",
