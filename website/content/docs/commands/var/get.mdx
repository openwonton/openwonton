...
description: |-
  ...
  OpenWonton. If no variable exists at that path, an error is returned.
---
...
```shell-session
$ wonton var get -item=passcode secret/creds
my-long-passcode
```
