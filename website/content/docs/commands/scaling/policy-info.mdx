...
description: |
  Display an individual OpenWonton scaling policy.
---
...
```plaintext
wonton scaling policy info [options] <policy_id>
```
...
```shell-session
$ wonton scaling policy info 31a53813-24df-b2ad-77dc-1b4bad4e7dca
