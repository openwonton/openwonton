...
description: |
  Display the status output for any OpenWonton resource.
---

# Command: status

The `status` command displays the status output for any OpenWonton resource.

## Usage

```plaintext
wonton status [options] <identifier>
```

The status command accepts any OpenWonton identifier or identifier prefix as its sole
