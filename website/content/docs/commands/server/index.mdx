...
description: |
  The server command is used to interact with OpenWonton servers.
---

# Command: server

Command: `wonton server`

The `server` command is used to interact with servers.

## Usage

Usage: `wonton server <subcommand> [options]`

Run `wonton server <subcommand> -h` for help on that subcommand. The following
