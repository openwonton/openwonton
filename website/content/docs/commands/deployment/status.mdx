...
```plaintext
wonton deployment status [options] <deployment id>
```
...
```shell-session
$ wonton deployment status 06ca68a2
ID          = 06ca68a2
Job ID      = example
Job Version = 0
Status      = successful
...
```shell-session
$ wonton deployment status -monitor -verbose dab
...
```shell-session
$ wonton deployment status -monitor e45
