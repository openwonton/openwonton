...
description: |
  The config validate command is used to validate OpenWonton configuration files.
---

# Command: config validate

The `config validate` command performs validation on a set of OpenWonton
configuration files. This is useful to test the OpenWonton configuration
...
configuring the OpenWonton agent. This option can be specified multiple
...
```shell-session
$ wonton config validate ./nomad.hcl
...
```shell-session
$ wonton config validate /etc/nomad.d
Configuration is valid!
```
