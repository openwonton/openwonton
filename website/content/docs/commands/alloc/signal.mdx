...
```plaintext
wonton alloc signal [options] <allocation> <task>
```
...
```shell-session
$ wonton alloc signal eb17e557

$ wonton alloc signal eb17e557 redis
...
```shell-session
$ wonton alloc signal -task redis eb17e557
```
...
```shell-session
$ wonton alloc signal -task redis eb17e557 api
```
