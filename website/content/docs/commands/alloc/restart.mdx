...
```plaintext
wonton alloc restart [options] <allocation> <task>
```
...
```shell-session
$ wonton alloc restart eb17e557

$ wonton alloc restart eb17e557 foo
...
```shell-session
$ wonton alloc restart -task redis eb17e557
```
...
```shell-session
$ wonton alloc restart -task redis eb17e557 api
```
