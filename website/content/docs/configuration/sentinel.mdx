...
description: >-
  The "sentinel" block configures the OpenWonton agent for Sentinel policies and
...
- `path` `(string: "")` - Specifies the path to the import plugin. Must be executable by OpenWonton.
