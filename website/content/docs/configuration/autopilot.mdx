...
description: >-
  The "autopilot" block configures the OpenWonton agent to configure Autopilot
  behavior.
---
...
The `autopilot` block configures the OpenWonton agent to configure Autopilot behavior.
