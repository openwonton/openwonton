---
layout: docs
page_title: Nomad Enterprise License FAQ (Upstream)
description: >-
  Frequently Asked Questions pertaining to upstream Nomad Enterprise Licensing.
---

# Frequently Asked Questions (FAQ)

-> NOTE: OpenWonton does not provide HashiCorp Nomad Enterprise licenses. This
page is retained for upstream reference only and applies to Nomad Enterprise.
