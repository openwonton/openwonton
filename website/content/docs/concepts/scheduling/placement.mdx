...
description: Learn about how placements are computed in OpenWonton.
---

# Placement

When the OpenWonton scheduler receives a job registration request, it needs to
...
[node attributes][] and are automatically detected by OpenWonton, static values
