...
description: Learn about how to author a OpenWonton plugin.
---
...
The `ConfigSchema` function allows a plugin to tell OpenWonton the schema for its
...
client config. The second, `AgentConfig`, is the OpenWonton agent's configuration
...
[hclspec]: https://godoc.org/github.com/openwonton/openwonton/plugins/shared/hclspec
