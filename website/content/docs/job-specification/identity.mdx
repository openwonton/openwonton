...
description: |-
  The "identity" block allows tasks to use their OpenWonton Workload Identity via an
...
environment variable or file. By default OpenWonton will create an identity for all
...
[taskuser]: /nomad/docs/job-specification/task#user "OpenWonton task Block"
