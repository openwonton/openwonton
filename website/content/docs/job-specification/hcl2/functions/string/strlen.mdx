...
length limits on string arguments; a OpenWonton provider is responsible for
translating OpenWonton's string representation into that used by its respective
