...
| `!!null`      | The OpenWonton language `null` value                                    |
...
The OpenWonton language automatic type conversion rules mean that you don't
...
OpenWonton language's type system cannot represent. Therefore this YAML decoder
