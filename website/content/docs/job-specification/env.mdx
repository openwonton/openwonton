...
OpenWonton also supports populating dynamic environment variables from data stored in
...
[template-env]: /nomad/docs/job-specification/template#environment-variables 'OpenWonton template Block'
