...
managed by OpenWonton for [Consul
...
- `config` `(map: nil)` - Proxy configuration that is opaque to OpenWonton and
...
[upstreams]: /nomad/docs/job-specification/upstreams 'OpenWonton upstream config Specification'
[expose]: /nomad/docs/job-specification/expose 'OpenWonton proxy expose configuration'
