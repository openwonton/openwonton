...
Envoy sidecar proxy managed by OpenWonton for [Consul Connect][learn-consul-connect].
...
[path]: /nomad/docs/job-specification/expose#path-parameters 'OpenWonton Expose Path Parameters'
[port]: /nomad/docs/job-specification/network#port-parameters 'OpenWonton Port Parameters'
