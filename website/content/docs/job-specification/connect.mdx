...
the [Secure OpenWonton Jobs with Consul Connect](/nomad/tutorials/integrate-consul/consul-service-mesh)
guide.
...
- `sidecar_service` - <code>([sidecar_service][]: nil)</code> - This is used to
  configure the sidecar service created by OpenWonton for Consul Connect.
...
- `gateway` - <code>([gateway][]:nil)</code> - This is used to configure the
  gateway service created by OpenWonton for Consul Connect.
...
[gh-7221]: https://github.com/openwonton/openwonton/issues/7221
...
[service_task]: /nomad/docs/job-specification/service#task-1 "OpenWonton service task"

[sidecar_service]: /nomad/docs/job-specification/sidecar_service "OpenWonton sidecar service Specification"

[sidecar_task]: /nomad/docs/job-specification/sidecar_task "OpenWonton sidecar task config Specification"

[task]: /nomad/docs/job-specification/task "OpenWonton task Job Specification"

[upstreams]: /nomad/docs/job-specification/upstreams "OpenWonton sidecar service upstreams Specification"
