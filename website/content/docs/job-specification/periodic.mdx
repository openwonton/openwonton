...
description: |-
  ...
  The easiest way to think about the periodic scheduler is "OpenWonton cron" or
  "distributed cron".
---
...
consistent evaluation when OpenWonton spans multiple time zones.
...
Though OpenWonton supports configuring `time_zone`, we strongly recommend that periodic
