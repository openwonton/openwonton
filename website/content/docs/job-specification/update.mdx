...
- `health_check` `(string: "checks")` - Specifies the mechanism in which
  ...
  - "manual" - Specifies that OpenWonton should not automatically determine health
...
[canary]: /nomad/tutorials/job-updates/job-blue-green-and-canary-deployments 'OpenWonton Canary Deployments'
[checks]: /nomad/docs/job-specification/service#check-parameters 'OpenWonton check Job Specification'
[rolling]: /nomad/tutorials/job-updates/job-rolling-update 'OpenWonton Rolling Upgrades'
[strategies]: /nomad/tutorials/job-updates 'OpenWonton Update Strategies'
