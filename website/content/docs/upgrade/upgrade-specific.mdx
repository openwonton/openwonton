...
Starting with OpenWonton 1.6.0, HashiCorp will no longer release 32-bit Intel builds
of OpenWonton and Nomad Enterprise (the builds named `windows_386` and
