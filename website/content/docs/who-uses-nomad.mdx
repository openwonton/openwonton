...
description: >-
  This page features many ways Nomad-compatible schedulers are used in
  production today across many industries to solve critical, real-world
  business objectives
---

# Who Uses Nomad

This page features talks from users on how they use Nomad and Nomad-compatible schedulers today to solve critical, real-world business objectives.

Upstream Nomad sees widespread adoption, and OpenWonton remains compatible for the same use cases, including production deployments at PagerDuty, Cloudflare, Roblox, Pandora, and more.
