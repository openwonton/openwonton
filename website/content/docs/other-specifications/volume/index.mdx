...
description: Learn about the Volume specification used to create and register volumes to OpenWonton.
---

# Volume Specification

The OpenWonton volume specification defines the schema for creating and registering
