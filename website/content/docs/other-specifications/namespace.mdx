...
description: Learn about OpenWonton's Namespace specification.
---
...
OpenWonton Namespaces may be specified as HCL files and submitted by the [`nomad
...
- `meta` `(object: null)` - Optional object with string keys and values of
  metadata to attach to the namespace. Namespace metadata is not used by OpenWonton
