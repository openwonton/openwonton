...
- [APMs](/nomad/tools/autoscaling/concepts/plugins/apm)
- [Strategies](/nomad/tools/autoscaling/concepts/plugins/strategy)
- [Targets](/nomad/tools/autoscaling/concepts/plugins/target)

In addition, each plugin implements a [base](/nomad/tools/autoscaling/concepts/plugins/base)
...
[noop_plugins]: https://github.com/openwonton/openwonton-autoscaler/tree/main/plugins/test
