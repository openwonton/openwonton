...
[`prometheus` plugin](https://github.com/openwonton/openwonton-autoscaler/tree/main/plugins/builtin/apm/prometheus).
...
[apm_plugin]: https://github.com/openwonton/openwonton-autoscaler/blob/v0.3.0/plugins/apm/apm.go#L11
[base_plugin]: /nomad/tools/autoscaling/concepts/plugins/base
[noop_plugin]: https://github.com/openwonton/openwonton-autoscaler/tree/v0.3.0/plugins/test/noop-apm
