...
manually, please see the documentation for the [`wonton operator root keyring`]
commands.
...
[`wonton operator root keyring`]: /nomad/docs/commands/operator/root/keyring-rotate
