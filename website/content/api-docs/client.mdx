...
```shell-session
$ wonton operator api /v1/client/metadata
```
...
```shell-session
$ wonton operator api /v1/client/metadata < meta.json
```
...
```shell-session
$ wonton operator api /v1/client/stats
```
...
```shell-session
$ wonton operator api /v1/client/gc
```
