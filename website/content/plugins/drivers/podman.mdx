...
The Podman task driver plugin for OpenWonton uses the [Pod Manager (podman)][podman]
daemonless container runtime for executing OpenWonton tasks. Podman supports OCI
containers and its command line tool is meant to be [a drop-in replacement]
[podman-cli] for docker.

Source is on [GitHub][github]

Download from the upstream driver [releases][releases]
...
[github]: https://github.com/openwonton/openwonton-driver-podman
...
[`examples/jobs/nats_group.nomad`]: https://github.com/openwonton/openwonton-driver-podman/blob/main/examples/jobs/nats_group.nomad
[`examples/jobs/nats_simple_pod.nomad`]: https://github.com/openwonton/openwonton-driver-podman/blob/main/examples/jobs/nats_simple_pod.nomad
[`examples/jobs/nats_pod.nomad`]: https://github.com/openwonton/openwonton-driver-podman/blob/main/examples/jobs/nats_pod.nomad
[homepage]: https://github.com/openwonton/openwonton-driver-podman
...
[releases]: https://github.com/hashicorp/nomad-driver-podman/releases
...
[downloaded]: https://github.com/hashicorp/nomad-driver-podman/releases
