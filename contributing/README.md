...
---
1. Install [Go 1.24.11+](https://golang.org/) *(Note: `gcc-go` is not supported)*
1. Clone this repo
   ```sh
   $ git clone https://github.com/openwonton/openwonton.git
   $ cd openwonton
...
Building the Web UI
---
See the [UI README](https://github.com/openwonton/openwonton/blob/main/ui/README.md) for instructions.
